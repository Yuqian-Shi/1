...
# ====================================
# Approach:
# All pixels can be divided into three groups: background, line and
# cross points.
# The cross points (point) were separated into two types: A and B,
# depending on which side the horizontal line is.
...
# The other end points of the three lines could be added to undraw-points-list.
...
def tellA(pos):
    Blist = [(pos[0] - 1, pos[1]), (pos[0] + 1, pos[1] + 1),
             (pos[0] + 1, pos[1] - 1)]
    for point in Blist:
